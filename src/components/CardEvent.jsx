    ...
    <Box sx={{ mb: 4 }}>
      <Card variant="outlined" sx={{ borderRadius: 2, backgroundColor: '#282828', color: '#fff' }}>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', height: '100%', py: 8 }}>
          ...
          <Button href={'/loadEvent'} sx={{ fontFamily: "'Circular Std', Arial, sans-serif", fontSize: 14, fontWeight: 700, color: '#fff', backgroundColor: '#1DB954', borderRadius: 2, px: 4, py: 2, '&:hover': { backgroundColor: '#1ed760' } }}>
            Crear evento
          </Button>
        </Box>
      </Card>
